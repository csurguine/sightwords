	...
	,UITableViewDelegate
{
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		//'customWordsList[selectedRow] = (newRowText,newRowText,"h-e-l-o")
	...
	@objc func addWord() {
		...
		//customWordsList.insert((key: "item1", word: "Item 1", phonetic: "i-t-eh-m"), at: 0)
	...
	func save() {
		...
		/*
		let a = NSArray(array: customWordsList)
		do {
